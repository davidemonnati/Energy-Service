...
var apartment_controller_1 = require("./controllers/apartment.controller");
var consumption_controller_1 = require("./controllers/consumption.controller");
typeorm_1.useContainer(typedi_1.Container);
routing_controllers_1.useContainer(typedi_1.Container);
var port = process.env.PORT || 3000;
var app = routing_controllers_1.createExpressServer({
    controllers: [
        apartment_controller_1.ApartmentController,
